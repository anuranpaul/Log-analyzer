...
public class LogService {
        ...
        if (filter != null) {
            ...
            if (filter.containsKey("metadata")) {
                ...
                if (metadataFilter != null && metadataFilter.containsKey("key")
                    ...
                    return logElasticsearchRepository.findByMetadataKeyAndValue(key, value);
                }
            }
    ...
    public List<Log> findByMetadata(String key, String value, int page, int size) {
        return logElasticsearchRepository.findByMetadataKeyAndValue(key, value, PageRequest.of(page, size))
                .getContent();
    }
}